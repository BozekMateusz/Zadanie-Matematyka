    ...
    >
      ...
      <main className="flex flex-col space-y-12 w-full max-w-5xl px-6">
        <section className="bg-white p-6 shadow-lg rounded-xl">
          <h2 className="text-2xl font-bold text-blue-700">Krok 1: Obliczenie miejsc zerowych</h2>
          <p className="mt-4 text-lg text-blue-600">
            Aby przekształcić funkcję ogólną do postaci iloczynowej, najpierw musimy obliczyć miejsca zerowe funkcji kwadratowej z postaci ogólnej <strong>f(x) = ax² + bx + c</strong>. Używamy wzoru kwadratowego:
            <strong>x₁, x₂ = (-b ± √(b² - 4ac)) / 2a</strong>.
          </p>
        </section>

        <section className="bg-white p-6 shadow-lg rounded-xl">
          <h2 className="text-2xl font-bold text-blue-700">Krok 2: Zastosowanie miejsc zerowych</h2>
          <p className="mt-4 text-lg text-blue-600">
            Po obliczeniu miejsc zerowych, funkcję kwadratową możemy zapisać w postaci iloczynowej: <strong>f(x) = a(x - x₁)(x - x₂)</strong>, gdzie x₁ i x₂ to obliczone miejsca zerowe.
          </p>
        </section>
