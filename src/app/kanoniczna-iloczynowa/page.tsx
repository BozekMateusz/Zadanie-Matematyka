    ...
    >
      ...
      <main className="flex flex-col space-y-12 w-full max-w-5xl px-6">
          ...
          <ul className="mt-4 text-lg text-blue-600 space-y-2">
            ...
            <li>
              ...
              <ul className="list-disc pl-6">
                <li>
                  <span>x<sub>1</sub> = <InlineMath>{`p - \\sqrt{-\\frac{q}{a}}`}</InlineMath></span>
                </li>
                <li className="mt-2">
                  <span>x<sub>2</sub> = <InlineMath>{`p + \\sqrt{-\\frac{q}{a}}`}</InlineMath></span>
                </li>
              </ul>
            </li>
          </ul>
        ...
        {examples.map((example, index) => {
          ...
          return (
            <section key={index} className="bg-white dark:bg-blue-100 hover:scale-105 transform transition-transform duration-300 p-6 shadow-lg rounded-xl">
              <h2 className="text-2xl font-bold text-blue-700">Przykład {index + 1}:</h2>
              ...
              <ol className="list-decimal mt-4 pl-6 text-lg text-blue-600 space-y-2">
                <li>
                  ...
                  <ul className="list-disc pl-6">
                    <li>
                      <span>x<sub>1</sub> = <InlineMath>{`${example.p} - \\sqrt{-\\frac{${example.q}}{${example.a}}}`}</InlineMath> = {roots[0]}</span>
                    </li>
                    <li>
                      <span>x<sub>2</sub> = <InlineMath>{`${example.p} + \\sqrt{-\\frac{${example.q}}{${example.a}}}`}</InlineMath> = {roots[1]}</span>
                    </li>
                  </ul>
                </li>
                <li>
