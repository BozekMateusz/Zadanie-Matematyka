      ...
      <main className="flex flex-col space-y-12 w-full max-w-5xl px-6">
        <section className="bg-white dark:bg-blue-100 p-6 shadow-lg rounded-xl">
          ...
          <ul className="mt-4 text-lg text-blue-600 space-y-2">
            <li>Postać kanoniczna: <span>f(x) = a(x - p)<sup>2</sup> + q</span></li>
            <li>Postać iloczynowa: <span>f(x) = a(x - x<sub>1</sub>)(x - x<sub>2</sub>)</span></li>
            <li>
        ...
        <section className="bg-white dark:bg-blue-100 p-6 shadow-lg rounded-xl">
          ...
          <ol className="list-decimal mt-4 pl-6 text-lg text-blue-600 space-y-2">
            ...
            <li>Postać iloczynowa: <span>f(x) = 2(x - 1)(x - 5)</span>.</li>
          </ol>
        </section>
        ...
        <section className="bg-white dark:bg-blue-100 p-6 shadow-lg rounded-xl">
          ...
          <ol className="list-decimal mt-4 pl-6 text-lg text-blue-600 space-y-2">
            ...
            <li>Postać iloczynowa: <span>f(x) = -3(x + 4)(x)</span>.</li>
          </ol>
        </section>
        ...
        <section className="bg-white dark:bg-blue-100 p-6 shadow-lg rounded-xl">
          ...
          <ol className="list-decimal mt-4 pl-6 text-lg text-blue-600 space-y-2">
            ...
            <li>Postać iloczynowa: <span>f(x) = 5(x + 1)(x - 3)</span>.</li>
          </ol>
        </section>
