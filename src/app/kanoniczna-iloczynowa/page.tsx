    ...
    <div className="min-h-screen flex flex-col items-center py-10 px-4 bg-gray-900 text-white transition-all duration-300">
      ...
      <main className="flex flex-col space-y-12 w-full max-w-5xl px-6">
                ...
                <li>
                  <span>
                    ...
                    <span className="inline-flex flex-col items-center ml-5">
                      <span>(-q)</span>
                      <span className="border-t-2 border-white w-full text-center">a</span>
                    </span>
                  </span>
                </li>
                <li className="mt-2">
        ...
        {examples.map((example, index) => {
          ...
          return (
            <section key={index} className="bg-slate-600 hover:scale-105 transform transition-transform duration-300 p-6 shadow-lg rounded-xl">
              <h2 className="text-2xl font-bold text-white">Przykład {index + 1}:</h2>
                    ...
                    <li className="mt-5">
                      <span>
                        ...
                        <span className="inline-flex flex-col items-center ml-5">
                          ...
                          <span className="border-t-2 border-white w-full text-center">{example.a}</span>
                        </span> = {roots[0]}
                      </span>
                    </li>
                    <li>
